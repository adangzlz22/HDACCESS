...
var PageClienteUnSoloUsoPageRoutingModule = /** @class */ (function () {
    function PageClienteUnSoloUsoPageRoutingModule() {
    }
    ...
    return PageClienteUnSoloUsoPageRoutingModule;
}());
...
var PageClienteUnSoloUsoPageModule = /** @class */ (function () {
    function PageClienteUnSoloUsoPageModule() {
    }
    ...
    return PageClienteUnSoloUsoPageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225 ;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PageClienteUnSoloUsoPage = /** @class */ (function () {
    function PageClienteUnSoloUsoPage(_VisPro, _UsuPro, navCtrl, route, alertCtrl) {
    ...
    PageClienteUnSoloUsoPage.prototype.ngOnInit = function () {
    };
    PageClienteUnSoloUsoPage.prototype.ionViewWillEnter = function () {
        this.Pagina = 0;
    ...
    PageClienteUnSoloUsoPage.prototype.ObtenerVisitas = function () {
        var _this = this;
        console.log('HOLA');
        this._VisPro.ObtenerVisitas(this.TipoVisita, this._UsuPro.PKUsuario, -1).then(function (result) {
            _this.DatosVisitas = [];
            _this.DatosVisitas = JSON.parse(result['Model']);
            console.log(_this.DatosVisitas);
            _this.numeroDeVisitas = 20;
            console.log(_this.DatosVisitas.length);
            if (parseInt(_this.Pagina) === 1) {
                if (_this.DatosVisitas.length > 0) {
                    _this.numeroDeVisitas = _this.DatosVisitas[0]['LimVisitasUnSoloUso'] - _this.DatosVisitas[0]['Registros'];
                }
            }
            if (parseInt(_this.Pagina) === 2) {
                if (_this.DatosVisitas.length > 0) {
                    _this.numeroDeVisitas = _this.DatosVisitas[0]['LimVisitasFrecuentes'] - _this.DatosVisitas[0]['Registros'];
                }
            }
    ...
    PageClienteUnSoloUsoPage.prototype.DirigirVentanaRegistro = function (obj) {
        this.navCtrl.navigateForward("page-cliente-un-solo-uso-registro/" + obj.PKVisita + "/" + this.TipoVisita);
    };
    PageClienteUnSoloUsoPage.prototype.AgregarRegistro = function () {
    ...
    PageClienteUnSoloUsoPage.prototype.Mensaje = function () {
    ...
    PageClienteUnSoloUsoPage.ctorParameters = function () { return [
    ...
    return PageClienteUnSoloUsoPage;
}());
...
//# sourceMappingURL=page-cliente-un-solo-uso-page-cliente-un-solo-uso-module-es5.js.map