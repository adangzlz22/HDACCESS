...
var PageAdministradorUsuariosRegistroPageRoutingModule = /** @class */ (function () {
    function PageAdministradorUsuariosRegistroPageRoutingModule() {
    }
    ...
    return PageAdministradorUsuariosRegistroPageRoutingModule;
}());
...
var PageAdministradorUsuariosRegistroPageModule = /** @class */ (function () {
    function PageAdministradorUsuariosRegistroPageModule() {
    }
    ...
    return PageAdministradorUsuariosRegistroPageModule;
}());
...
var PageAdministradorUsuariosRegistroPage = /** @class */ (function () {
    function PageAdministradorUsuariosRegistroPage(route, _usuProv, navCtrl, alertCtrl, _resiProv) {
        this.route = route;
    ...
    PageAdministradorUsuariosRegistroPage.prototype.ngOnInit = function () {
    };
    PageAdministradorUsuariosRegistroPage.prototype.ionViewWillEnter = function () {
    ...
    PageAdministradorUsuariosRegistroPage.prototype.CrearUsuarios = function () {
        var _this = this;
        if (this.Contrasena != '' || this.ContrasenaVerif != '') {
            if (this.Contrasena == this.ContrasenaVerif) {
                if (this.Desaparecer == true) {
                    //Modificar Usuario
                    this._usuProv.ActualizarUsuarios(this.PKUsuario, this.NombreCompleto, this.Correo, this.Telefono, this.Contrasena, this.PKResidencia).then(function (result) {
                        _this.navCtrl.pop();
                        console.log(result);
    ...
    PageAdministradorUsuariosRegistroPage.prototype.EliminarUsuarios = function () {
        var _this = this;
        this._usuProv.EliminarUsuarios(this.PKUsuario).then(function (result) {
            console.log(result);
            _this.navCtrl.pop();
        }).catch(function (error) {
            console.log(error);
    ...
    PageAdministradorUsuariosRegistroPage.prototype.Mensaje = function () {
    ...
    PageAdministradorUsuariosRegistroPage.prototype.MensajeExiste = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PageAdministradorUsuariosRegistroPage.prototype.MensajeFalta = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PageAdministradorUsuariosRegistroPage.prototype.ObtenerResidencias = function () {
        var _this = this;
        this._resiProv.ObtenerResidencias('').then(function (result) {
            _this.DatosResidencias = JSON.parse(result['Model']);
        }).catch(function (error) {
            console.log(error);
        });
    };
    PageAdministradorUsuariosRegistroPage.prototype.Elejir = function () {
    };
    PageAdministradorUsuariosRegistroPage.prototype.ExisteUsuario = function () {
        var _this = this;
        if (this.FKNivel == 1) {
            this._usuProv.CrearUsuarios(this.NombreCompleto, this.Correo, this.Telefono, this.Contrasena, this.PKResidencia, this.FKNivel, this.FKMenuBandera).then(function (result) {
                console.log(result);
                _this.lstExiste = [];
                _this.navCtrl.pop();
            }).catch(function (error) {
            ...
            this._resiProv.ExisteUsuario(this.PKResidencia, this.FKNivel).then(function (result) {
                _this.lstExiste = JSON.parse(result['Model']);
                console.log(_this.lstExiste);
                if (_this.lstExiste.length != 0) {
                    _this.MensajeExiste();
                }
                else {
                    _this._usuProv.CrearUsuarios(_this.NombreCompleto, _this.Correo, _this.Telefono, _this.Contrasena, _this.PKResidencia, _this.FKNivel, _this.FKMenuBandera).then(function (result) {
                        console.log(result);
                        _this.lstExiste = [];
                        _this.navCtrl.pop();
                    }).catch(function (error) {
    ...
    PageAdministradorUsuariosRegistroPage.prototype.onSubmit = function () {
        console.log('AQUI ANMDAMOS');
    };
    PageAdministradorUsuariosRegistroPage.ctorParameters = function () { return [
    ...
    return PageAdministradorUsuariosRegistroPage;
}());
...
//# sourceMappingURL=page-administrador-usuarios-registro-page-administrador-usuarios-registro-module-es5.js.map