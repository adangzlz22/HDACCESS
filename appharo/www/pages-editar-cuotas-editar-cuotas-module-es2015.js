...
let EditarCuotasPageRoutingModule = class EditarCuotasPageRoutingModule {
};
...
let EditarCuotasPageModule = class EditarCuotasPageModule {
};
...
let EditarCuotasPage = class EditarCuotasPage {
    constructor(resi, route, navCtrl) {
        this.resi = resi;
        this.route = route;
    ...
    Actualizar() {
        this.resi.Actualizar(this.IdCatTipoSuscripcion, this.Costo).then((result) => {
            this.navCtrl.pop();
        }).catch(error => {
            console.log(error);
        });
...
EditarCuotasPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-editar-cuotas-editar-cuotas-module-es2015.js.map