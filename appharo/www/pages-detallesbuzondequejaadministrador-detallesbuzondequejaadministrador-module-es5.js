...
var DetallesbuzondequejaadministradorPageRoutingModule = /** @class */ (function () {
    function DetallesbuzondequejaadministradorPageRoutingModule() {
    }
    ...
    return DetallesbuzondequejaadministradorPageRoutingModule;
}());
...
var DetallesbuzondequejaadministradorPageModule = /** @class */ (function () {
    function DetallesbuzondequejaadministradorPageModule() {
    }
    ...
    return DetallesbuzondequejaadministradorPageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225;\n}\n\n.padding {\n  padding: 5% !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DetallesbuzondequejaadministradorPage = /** @class */ (function () {
    function DetallesbuzondequejaadministradorPage(route, navCtrl, buzonPrivder) {
        this.route = route;
        this.navCtrl = navCtrl;
        this.buzonPrivder = buzonPrivder;
    }
    DetallesbuzondequejaadministradorPage.prototype.ngOnInit = function () {
    ...
    DetallesbuzondequejaadministradorPage.prototype.Guardar = function () {
        var _this = this;
        this.buzonPrivder.Guardar(this.PKBuzonDeQueja, this.Estatus).then(function (result) {
            console.log(result);
            _this.navCtrl.pop();
        }).catch(function (err) {
            console.log(err);
    ...
    DetallesbuzondequejaadministradorPage.prototype.Cancelar = function () {
        this.navCtrl.pop();
    };
    DetallesbuzondequejaadministradorPage.ctorParameters = function () { return [
    ...
    return DetallesbuzondequejaadministradorPage;
}());
...
//# sourceMappingURL=pages-detallesbuzondequejaadministrador-detallesbuzondequejaadministrador-module-es5.js.map