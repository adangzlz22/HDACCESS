...
var VerAreaComunResidentePageRoutingModule = /** @class */ (function () {
    function VerAreaComunResidentePageRoutingModule() {
    }
    ...
    return VerAreaComunResidentePageRoutingModule;
}());
...
var VerAreaComunResidentePageModule = /** @class */ (function () {
    function VerAreaComunResidentePageModule() {
    }
    ...
    return VerAreaComunResidentePageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225;\n}\n\n.padding {\n  padding: 5% !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var VerAreaComunResidentePage = /** @class */ (function () {
    function VerAreaComunResidentePage(AreaProvider, navCtrl, route) {
        this.AreaProvider = AreaProvider;
        this.navCtrl = navCtrl;
        this.route = route;
    }
    VerAreaComunResidentePage.prototype.ngOnInit = function () {
    };
    VerAreaComunResidentePage.prototype.ionViewWillEnter = function () {
    ...
    VerAreaComunResidentePage.prototype.ObtenerMesAreaComun = function () {
        var _this = this;
        this.AreaProvider.ObtenerMesAreaComun().then(function (result) {
            _this.lstMes = JSON.parse(result['Model']);
        }).catch(function (err) {
            console.log(err);
        });
    };
    VerAreaComunResidentePage.prototype.ObtenerAreaComun = function (item) {
        this.navCtrl.navigateForward("detalles-area-comun/" + this.FKResidencia + "/" + this.FKNivel + "/" + item.Fecha);
    };
    VerAreaComunResidentePage.ctorParameters = function () { return [
    ...
    return VerAreaComunResidentePage;
}());
...
//# sourceMappingURL=pages-ver-area-comun-residente-ver-area-comun-residente-module-es5.js.map