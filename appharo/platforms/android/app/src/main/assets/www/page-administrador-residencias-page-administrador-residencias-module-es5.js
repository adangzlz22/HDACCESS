...
var PageAdministradorResidenciasPageRoutingModule = /** @class */ (function () {
    function PageAdministradorResidenciasPageRoutingModule() {
    }
    ...
    return PageAdministradorResidenciasPageRoutingModule;
}());
...
var PageAdministradorResidenciasPageModule = /** @class */ (function () {
    function PageAdministradorResidenciasPageModule() {
    }
    ...
    return PageAdministradorResidenciasPageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225 ;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PageAdministradorResidenciasPage = /** @class */ (function () {
    function PageAdministradorResidenciasPage(_resiProv, navCtrl) {
        this._resiProv = _resiProv;
        this.navCtrl = navCtrl;
        this.DatosResidencias = [];
    }
    PageAdministradorResidenciasPage.prototype.ngOnInit = function () {
    };
    PageAdministradorResidenciasPage.prototype.ionViewWillEnter = function () {
        this.NombreResidencia = '';
        this.ObtenerResidencias();
    };
    PageAdministradorResidenciasPage.prototype.ObtenerResidencias = function () {
        var _this = this;
    ...
    PageAdministradorResidenciasPage.prototype.Actualizar = function (item) {
    ...
    PageAdministradorResidenciasPage.prototype.AgregarNuevo = function () {
        this.navCtrl.navigateForward("page-administrador-residencias-registro/" + 0 + "/" + 0 + "/" + 0 + "/" + 0 + "/" + 0);
    };
    PageAdministradorResidenciasPage.ctorParameters = function () { return [
    ...
    return PageAdministradorResidenciasPage;
}());
...
//# sourceMappingURL=page-administrador-residencias-page-administrador-residencias-module-es5.js.map