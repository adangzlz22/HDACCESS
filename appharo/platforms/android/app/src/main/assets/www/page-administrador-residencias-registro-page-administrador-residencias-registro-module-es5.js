...
var PageAdministradorResidenciasRegistroPage = /** @class */ (function () {
    ...
    PageAdministradorResidenciasRegistroPage.prototype.Guardar = function () {
        ...
        if (this.Desaparecer == false) {
            ...
            this.ResiProvi.ActualizarResidencias(this.PKResidencia, this.NombreResidencia, this.LimVisitasFrecuentes, this.LimVisitasUnSoloUso, this.WhatsappCorreo, this.lstDiasActivados, this.Dispositivo, this.TokenMercado, this.KeyMercado).then(function (result) {
                console.log(result);
                _this.navCtrl.pop();
            }).catch(function (error) {
                console.log(error);
