...
var TagsPage = /** @class */ (function () {
    function TagsPage(navCtrl, usuario, route, _resi, alertCtrl) {
    ...
    TagsPage.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            if (params['pago']) {
                ...
                console.log(_this.pago);
                _this.userName = _this.pago['userObj'].NombreCompleto;
                _this.tags = _this.pago.PersonID;
            }
        });
    };
    TagsPage.prototype.buscarResidente = function () {
    ...
    TagsPage.prototype.BuscarTAGS = function () {
        var navigationExtras = {
            queryParams: {
                pago: JSON.stringify(this.pago),
            }
        ...
        // this.modalCtrl.create(BuscadorResidenteComponent ).present();
        this.navCtrl.navigateForward("buscarTAGS", navigationExtras).then(function (response) {
            console.log(response);
        });
    };
    TagsPage.prototype.AsignarTAGS = function () {
        var _this = this;
        if (this.validarVacios() == false) {
            this.Mensaje();
        }
        else {
            var person = this.pago.PersonID;
            var PKUsuario = this.pago['userObj'].PKUsuario;
            var nombre = this.pago['userObj'].NombreCompleto;
            this._resi.CrearTAGS(PKUsuario, person, nombre).then(function (result) {
                console.log(result);
                _this.pago = {
                    total: 0,
                    tipo: 0,
                ...
                _this.userName = 'No seleccionado';
                _this.tags = 'No seleccionado';
            }).catch(function (error) {
                console.log(error);
            });
        }
    };
    TagsPage.prototype.validarVacios = function () {
        var retu = false;
    ...
    TagsPage.prototype.Mensaje = function () {
