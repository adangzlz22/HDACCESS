...
var PageAdministradorDashboardPageRoutingModule = /** @class */ (function () {
    function PageAdministradorDashboardPageRoutingModule() {
    }
    ...
    return PageAdministradorDashboardPageRoutingModule;
}());
...
var PageAdministradorDashboardPageModule = /** @class */ (function () {
    function PageAdministradorDashboardPageModule() {
    }
    ...
    return PageAdministradorDashboardPageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225 ;\n}\n\n.padding {\n  padding: 5% !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PageAdministradorDashboardPage = /** @class */ (function () {
    function PageAdministradorDashboardPage(popover) {
        this.popover = popover;
    }
    PageAdministradorDashboardPage.prototype.ngOnInit = function () {
    };
    PageAdministradorDashboardPage.prototype.CreatePopOver = function (evento) {
        this.popover.create({ component: _popovercomponent_popovercomponent_page__WEBPACK_IMPORTED_MODULE_3__["PopovercomponentPage"],
            showBackdrop: false,
            event: evento,
            backdropDismiss: false }).then((function (popoverelement) {
            popoverelement.present();
        }));
    };
    PageAdministradorDashboardPage.ctorParameters = function () { return [
    ...
    return PageAdministradorDashboardPage;
}());
...
//# sourceMappingURL=page-administrador-dashboard-page-administrador-dashboard-module-es5.js.map