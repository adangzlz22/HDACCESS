...
var PageClientePerfilPageRoutingModule = /** @class */ (function () {
    function PageClientePerfilPageRoutingModule() {
    }
    ...
    return PageClientePerfilPageRoutingModule;
}());
...
var PageClientePerfilPageModule = /** @class */ (function () {
    function PageClientePerfilPageModule() {
    }
    ...
    return PageClientePerfilPageModule;
}());
...
var PageClientePerfilPage = /** @class */ (function () {
    function PageClientePerfilPage(_UsuProv, navCtrl) {
    ...
    PageClientePerfilPage.prototype.ngOnInit = function () {
    ...
    PageClientePerfilPage.prototype.ActualizarPerfil = function () {
        var _this = this;
        console.log('HOLA');
        this._UsuProv.ActualizarPerfil(this.NombreCompleto, this.Correo, this.Telefono).then(function (result) {
            console.log(result);
            _this._UsuProv.NombreCompleto = _this.NombreCompleto;
            _this._UsuProv.Correo = _this.Correo;
            _this._UsuProv.Telefono = _this.Telefono;
            _this.navCtrl.pop();
        }).catch(function (Error) {
            console.log(Error);
        });
    };
    PageClientePerfilPage.prototype.navEstadoCuenta = function () {
        var obj = {
    ...
    PageClientePerfilPage.ctorParameters = function () { return [
...
//# sourceMappingURL=page-cliente-perfil-page-cliente-perfil-module-es5.js.map