...
var PageClienteFrecuentesPageRoutingModule = /** @class */ (function () {
    function PageClienteFrecuentesPageRoutingModule() {
    }
    ...
    return PageClienteFrecuentesPageRoutingModule;
}());
...
var PageClienteFrecuentesPageModule = /** @class */ (function () {
    function PageClienteFrecuentesPageModule() {
    }
    ...
    return PageClienteFrecuentesPageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225 ;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PageClienteFrecuentesPage = /** @class */ (function () {
    function PageClienteFrecuentesPage(_VisPro, _UsuPro) {
        this._VisPro = _VisPro;
        this._UsuPro = _UsuPro;
        this.DatosVisitas = [];
    }
    PageClienteFrecuentesPage.prototype.ngOnInit = function () {
        this.ObtenerVisitas();
    };
    PageClienteFrecuentesPage.prototype.ObtenerVisitas = function () {
        var _this = this;
        console.log('HOLA');
        this._VisPro.ObtenerVisitas(2, this._UsuPro.PKUsuario, -1).then(function (result) {
            _this.DatosVisitas = JSON.parse(result['Model']);
            console.log(_this.DatosVisitas);
            _this.numeroDeVisitas = _this.DatosVisitas[0]['LimVisitasFrecuentes'] - _this.DatosVisitas[0]['SumaVisitasFrecuentes'];
        }).catch(function (Error) {
            console.log(Error);
        });
    };
    PageClienteFrecuentesPage.ctorParameters = function () { return [
    ...
    return PageClienteFrecuentesPage;
}());
...
//# sourceMappingURL=page-cliente-frecuentes-page-cliente-frecuentes-module-es5.js.map