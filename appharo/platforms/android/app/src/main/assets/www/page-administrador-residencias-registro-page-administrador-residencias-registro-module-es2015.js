...
let PageAdministradorResidenciasRegistroPage = class PageAdministradorResidenciasRegistroPage {
    ...
    Guardar() {
        ...
        if (this.Desaparecer == false) {
            ...
            this.ResiProvi.ActualizarResidencias(this.PKResidencia, this.NombreResidencia, this.LimVisitasFrecuentes, this.LimVisitasUnSoloUso, this.WhatsappCorreo, this.lstDiasActivados, this.Dispositivo, this.TokenMercado, this.KeyMercado).then(result => {
                console.log(result);
                this.navCtrl.pop();
            }).catch(error => {
                console.log(error);
