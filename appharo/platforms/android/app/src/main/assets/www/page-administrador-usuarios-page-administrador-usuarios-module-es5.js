...
var PageAdministradorUsuariosPageRoutingModule = /** @class */ (function () {
    function PageAdministradorUsuariosPageRoutingModule() {
    }
    ...
    return PageAdministradorUsuariosPageRoutingModule;
}());
...
var PageAdministradorUsuariosPageModule = /** @class */ (function () {
    function PageAdministradorUsuariosPageModule() {
    }
    ...
    return PageAdministradorUsuariosPageModule;
}());
...
module.exports = ".color {\n  --ion-background-color: #FF8225 ;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PageAdministradorUsuariosPage = /** @class */ (function () {
    function PageAdministradorUsuariosPage(_usuProv, navCtrl, route) {
    ...
    PageAdministradorUsuariosPage.prototype.ionViewWillEnter = function () {
    ...
    PageAdministradorUsuariosPage.prototype.ngOnInit = function () {
    };
    PageAdministradorUsuariosPage.prototype.ObtenerUsuarios = function () {
        var _this = this;
        this._usuProv.ObtenerUsuarios(this.NombreCompleto, this.PKUsuario, this.FKNivel, this.FKResidencia).then(function (result) {
            _this.DatosUsuarios = JSON.parse(result['Model']);
        }).catch(function (error) {
            console.log(error);
        });
    };
    PageAdministradorUsuariosPage.prototype.ActualizarUsuarios = function (item) {
    ...
    PageAdministradorUsuariosPage.prototype.MoverAgregarUsuario = function () {
    ...
    PageAdministradorUsuariosPage.ctorParameters = function () { return [
    ...
    return PageAdministradorUsuariosPage;
}());
...
//# sourceMappingURL=page-administrador-usuarios-page-administrador-usuarios-module-es5.js.map